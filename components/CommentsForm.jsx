    ...
    <div className='bg-white shadow-lg rounded-lg pb-12 p-8 mb-8 text-black'>
        ...
        <div className='mt-8'>
          ...
          onClick={handleCommentSubmission}
           type='button'
            className='transition duration-500 easy hover:bg-indigo-900 inline-block bg-indigo-400 rounded-full text-white font-medium text-lg py-3 px-10 cursor-pointer'>
              Post Comment
              </button>
